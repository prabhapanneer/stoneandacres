...
export class LandOwnersComponent implements OnInit {
  ...
  currentYear: any; enquiry_list: any = [];
  ...
  onSubmit() {
    ...
    this.landOwnerForm.form_data = { name: this.landOwnerForm.name, email: this.landOwnerForm.email, mobile: this.landOwnerForm.mobile, message: this.landOwnerForm.message, project: null, form_type: this.landOwnerForm.type, location: this.landOwnerForm.location, land_extend: { Landextent_name: this.landOwnerForm.Landextent, Landextent_type: this.landOwnerForm.Landextent_type } };
    this.landOwnerForm.enquiry_list = true;

    this.storeApi.MAIL(this.landOwnerForm).subscribe((result) => {
      this.landOwnerForm.enquiry_list = false;
      if (result.status) {
